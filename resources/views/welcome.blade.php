  ...
  <section id="hero" class="hero d-flex align-items-center">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <h1 data-aos="fade-up">
            ...
            @endauth
            @else
            Welcome user you are not loged in 
            @endif
          </h1>
     ...
     Thanks for visiting our site 
            @endauth
            @else
So Please login Right now verify by email
...
@enderror
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Amankhalsa</span> {{date('Y')}}</strong>. All Rights Reserved
      </div>
      <div class="credits">
       
        Designed by <a href="https://Amankhalsa.in">Amankhalsa.in</a>
      </div>
    </div>
  </footer><!-- End Footer -->
